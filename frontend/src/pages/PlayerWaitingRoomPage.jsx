      ...
      <div className="max-w-5xl mx-auto px-4 py-6 sm:px-6 sm:py-10">
        ...
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-6 items-start">
          <div className="rounded-[28px] border border-white/10 bg-white/[0.04] backdrop-blur-xl p-5 sm:p-6">
            ...
            <h1 className="text-3xl sm:text-4xl font-black mt-3 leading-tight">You are in. Get ready for the live session.</h1>
              ...
              <div className="p-5 space-y-4">
                <div className="rounded-3xl min-h-[240px] bg-gradient-to-br from-[#34116a] via-[#35207f] to-[#111a31] border border-white/10 p-6 flex flex-col justify-between">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="px-3 py-1 rounded-full bg-black/30 text-xs font-bold">Countdown</div>
                  </div>
                  <div>
                    <div className="text-3xl sm:text-4xl font-black leading-tight">The live experience is about to begin.</div>
                    <div className="mt-3 text-white/70 text-sm sm:text-base">Sponsor media • Real-time ranking • Mobile-first participation • Live excitement</div>
                  </div>
                </div>

                <div className="grid grid-cols-2 gap-3">
                  {['Fast access', 'Big-screen sync', 'Reward moments', 'Low-friction play'].map((item) => (

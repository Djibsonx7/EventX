...
export default function LiveSessionPage({ sessionCode = 'EVX-4821', mode = 'Quiz Battle Live', onBackClick }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid xl:grid-cols-[1.1fr_0.9fr] gap-8">
          <div>
            ...
            <h1 className="text-4xl md:text-5xl font-black mt-3">Session ready to go live.</h1>
            ...
            <div className="mt-8 rounded-[30px] border border-white/10 bg-gradient-to-br from-[#151d34] to-[#0a1221] p-6 shadow-2xl">
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="px-4 py-2 rounded-full bg-emerald-500/15 border border-emerald-400/20 text-emerald-300 text-sm font-semibold">
                  Waiting Room Active
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                <button className="px-6 py-4 rounded-2xl bg-gradient-to-r from-[#7c3aed] to-[#ec4899] font-semibold shadow-[0_0_35px_rgba(124,58,237,0.35)]">
                  Start Experience
                </button>
          ...
          >
            ...
            <div className="mt-6 rounded-[26px] border border-white/10 bg-[#0b1326] overflow-hidden">
              <div className="px-5 py-4 border-b border-white/10 flex items-center justify-between">
                <div>
                  <div className="text-xs uppercase tracking-[0.25em] text-white/40">Now Joining</div>
                  <div className="text-lg font-bold mt-1">{mode}</div>
                </div>
                <div className="px-3 py-1 rounded-full bg-white/10 text-xs font-semibold">Sponsor On</div>
              </div>
              ...
              <div className="p-5 space-y-4">
                <div className="rounded-3xl min-h-[220px] bg-gradient-to-br from-[#34116a] via-[#35207f] to-[#111a31] border border-white/10 p-6 flex flex-col justify-between">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="px-3 py-1 rounded-full bg-black/30 text-xs font-bold">Waiting Countdown</div>
                  </div>
                  <div>
                    <div className="text-3xl font-black leading-tight">Join now and be ready when the host launches the session.</div>
                    <div className="mt-3 text-white/70 text-sm">Live room • Sponsor visibility • Mobile-first participation</div>
                  </div>
                </div>
